...
screen.addshape("robbery.gif")
screen.addshape("police.gif")
...
target_turtle.shape("robbery.gif")
target_turtle.penup()
    ...
    for g_state in goal_states:
        ...
        while min_duration_time != 1000:
            ...
            if show:
                ...
                score_turtle.clear()
                score_turtle.write(f"Tom's Score: {score}  Jerry's Score: {prey_score}", font=("Arial", 10, "bold"))
                agent_turtle.speed(4)
                target_turtle.speed(4)
